...
<head>
	...
	<title>TreeCmp Application</title>
...
<body>
	...
	<div class="container-fluid">
		...
		<form:form method="POST" commandName="newickStringNew" action="/TreeCmpGUI/checkNewick">
			<div class="row">
				<div class="col-xs-12 col-xs-offset-0 col-lg-offset-1 main">
 					<div class="form-group">
						<div class="radio">
							<label>
								<form:radiobutton path="comparisionMode" id="rbMatrix" value="-m" onclick="HideSecondWindow();"/>Matrix comparison
							</label>
						</div>
						<div class="radio">
							<label>
								<form:radiobutton path="comparisionMode" id="rbBipartite" value="-r" onclick="ShowSecondWindow();"/>Bipartite comparison
							</label>
						</div>
						<div style="margin-left: 15px;">
							<form:errors path="comparisionMode" cssClass="error" />
						</div>
					</div>
								...
								<table class="fixed smallMargin" style="display: block;">
	                                <tbody>
	                                	<tr class="row1">
		                                    ...
		                                    <td class="sidebar-version" style="text-align:left;">
										...
										<div class="panel panel-default">
											...
											<div id="collapse1" class="panel-collapse collapse" role="tabpanel" aria-labelledby="infoBox1">
												<div class="panel-body">
													<div class="form-group">
														<form:checkboxes element="span class='checkbox'" items="${rootedMetrics}" path="rootedMetrics" style="margin-left:-5px;"/>
													</div>
												</div>
											</div>
											...
											<div id="collapse2" class="panel-collapse collapse" role="tabpanel" aria-labelledby="infoBox2">
												<div class="panel-body">
													<div class="form-group">
														<form:checkboxes element="span class='checkbox'" items="${unrootedMetrics}" path="unrootedMetrics" style="margin-left:-5px;"/>
													</div>
												</div>
											</div>
										</div>
										<div>
											<form:errors path="hasMetrics" cssClass="error" />
										</div>
										<div class="panel panel-default">
											...
											<div id="collapse3" class="panel-collapse collapse" role="tabpanel" aria-labelledby="infoBox3">
												<div class="panel-body">							
													...
													<span class="item">
														<form:checkbox path="normalizedDistances" style="margin-left:-5px;"/>
														<label>Normalized distances</label>
													</span>
													<br/>
													<span class="item">
														<form:checkbox path="pruneTrees" style="margin-left:-5px;"/>
														<label>Prune trees</label>
													</span>
													<br/>
													<span class="item">
														<form:checkbox path="includeSummary" style="margin-left:-5px;"/>
			...
			<form:errors path="newickStringFirst">
			</form:errors>
		</div>
		<!-- FOOTER -->
